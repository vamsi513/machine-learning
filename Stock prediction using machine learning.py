...
# Change the prediction values by adding 10 to each prediction
y_pred = y_pred + 10
...
mpf.plot(ohlc, type='candle', style='yahoo', title="Stock Price Prediction Using machine Learning- "SADU.VAMSI KRISHNA, ylabel='Price',
